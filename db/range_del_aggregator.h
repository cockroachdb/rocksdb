...
class RangeDelAggregator {
 public:
  ...
  // largest. If smallest (or largest) is null, it is not used for
  // truncation. When adding range tombstones present in an sstable,
  // smallest and largest should be set to the smallest and largest
  // keys from the sstable file metadata. 
